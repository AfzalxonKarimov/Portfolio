...
const buttonVariants = cva(
  "group relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 overflow-hidden",
  {
    variants: {
      variant: {
        primary:
          "bg-foreground text-background hover:-translate-y-0.5 hover:shadow-[0_8px_30px_-10px_rgba(198,138,70,0.45)] active:translate-y-0",
        accent:
          "bg-accent text-accent-foreground hover:-translate-y-0.5 hover:shadow-[0_8px_30px_-8px_rgba(198,138,70,0.55)] active:translate-y-0",
        outline:
